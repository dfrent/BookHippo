class Book < ApplicationRecord
  ...
  def self.find_or_api_call(isbn)
    ...
    if book
      ...
      Book.create(isbn: isbn, title: book["title"], author: authors_string, description: book["description"], book_cover: book["imageLinks"]["thumbnail"], small_thumbnail: book["imageLinks"]["smallThumbnail"], genre_id: 1, google_id: google_id, page_count: book["pageCount"], average_rating: book["averageRating"] )
    end
  end
end
